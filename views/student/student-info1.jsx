...
const StudentInfo = React.createClass({
    ...
    addGradeHandleOk() {
        ...
        let url= "grade/save";
        let _data = {gradeName:$("#gradeName").val()};
        let type = "get";
        this._ajax(url,type,_data);
    },
    ...
    searchGrade(){
        let url= "grade/list";
        let _data = {gradeName:$("#search_gradeName").val()};
        let type = "get";
        this._ajax(url,type,_data);
    },
    ...
    render() {
        ...
        function showEditModal(id,object) {
          ...
          $.ajax({
              ...
              contentType: "application/json; charset=utf-8",
              success: function(data) {
                $("#edit_gradeName").val(data.gradeName);
                $("#edit_id").val(data.id);
              }.bind(this),
              error: function(xhr, status, err) {
                console.error("/delete/"+id, status, err.toString());
        ...
        function editSubmit() {
          console.log(self);
          let url= "grade/edit";
          let _data = {id:$("#edit_id").val(),gradeName:$("#edit_gradeName").val()};
          let type = "get";
